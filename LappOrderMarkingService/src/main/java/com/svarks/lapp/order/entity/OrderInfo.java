...
@NamedQueries({
		...
		@NamedQuery(name = "OrderInfo.getMyOrderCount", query = "SELECT DISTINCT COUNT(e) FROM OrderInfo e INNER JOIN OrderLineItem ol on e.salesOrderno=ol.salesOrderno WHERE (e.countryCode =:countryCode OR e.createdBy='FTP') AND (ol.productionOrderStatus='Released' OR ol.productionOrderStatus='Rel')"),
		@NamedQuery(name = "OrderInfo.getMyProcessedCount", query = "SELECT DISTINCT COUNT(e) FROM OrderInfo e INNER JOIN OrderLineItem ol on e.salesOrderno=ol.salesOrderno WHERE (e.countryCode =:countryCode OR e.createdBy='FTP') AND (ol.productionOrderStatus !='Released' AND ol.productionOrderStatus !='Rel')"),
		...
		@NamedQuery(name = "OrderInfo.getMyOrderBySalesAndAdmin", query = "SELECT DISTINCT e FROM OrderInfo e ,OrderLineItem ol WHERE e.salesOrderno =:salesOrderno AND (e.countryCode =:countryCode) AND (ol.productionOrderStatus='Released' OR ol.productionOrderStatus='Rel')"),
...
@NamedNativeQuery(name = "OrderInfo.getMyOrderByProdOrderAndAdmin", query = "SELECT DISTINCT * FROM order_info e INNER JOIN order_line_item ol on e.sales_orderno=ol.sales_orderno WHERE (e.country_code =:countryCode) AND ol.production_orderno=:productionOrderno AND (ol.production_order_status='Released' OR ol.production_order_status='Rel')", resultClass = OrderInfo.class)
...
@NamedNativeQuery(name = "OrderInfo.getOrderByAdmin", query = "SELECT DISTINCT * FROM order_info e INNER JOIN order_line_item ol on e.sales_orderno=ol.sales_orderno  WHERE (e.country_code =:countryCode) AND (ol.production_order_status='Released' OR ol.production_order_status='Rel') group by e.sales_orderno limit :startLimit,:endLimit", resultClass = OrderInfo.class)
@NamedNativeQuery(name = "OrderInfo.getMyOrderByDate", query = "SELECT DISTINCT * FROM order_info e INNER JOIN order_line_item ol on e.sales_orderno=ol.sales_orderno  WHERE e.country_code =:countryCode AND (e.created_date >=:startDate AND e.created_date <=:endDate) AND (ol.production_order_status='Released' OR ol.production_order_status='Rel') group by e.sales_orderno limit :startLimit,:endLimit", resultClass = OrderInfo.class)
@NamedNativeQuery(name = "OrderInfo.getProcessedOrderByDate", query = "SELECT DISTINCT * FROM order_info e INNER JOIN order_line_item ol on e.sales_orderno=ol.sales_orderno  WHERE e.country_code =:countryCode AND (e.created_date >=:startDate AND e.created_date <=:endDate) AND (ol.production_order_status !='Released' AND ol.production_order_status !='Rel') group by e.sales_orderno limit :startLimit,:endLimit", resultClass = OrderInfo.class)
...
@NamedNativeQuery(name = "OrderInfo.getProcessedOrderByAdmin", query = "SELECT DISTINCT * FROM order_info e INNER JOIN order_line_item ol on e.sales_orderno=ol.sales_orderno  WHERE (e.country_code =:countryCode) AND (ol.production_order_status !='Released' AND ol.production_order_status !='Rel') group by e.sales_orderno limit :startLimit,:endLimit", resultClass = OrderInfo.class)
